...
const relatedMap: Record<string, string[]> = {
  ...
  "/typing": ["/reaction", "/reading", "/word-speed"],
  ...
  "/sequence": ["/visual-memory", "/pattern", "/chimp"],
  "/verbal": ["/memory", "/reading", "/word-association"],
  "/stroop": ["/reaction", "/verbal", "/color-blind"],
  "/color-blind": ["/stroop", "/color-match", "/visual-memory"],
  "/math": ["/math-memory", "/memory", "/reverse-memory"],
  ...
  "/rhythm": ["/audio-memory", "/sequence", "/memory"],
  "/pattern": ["/math", "/sequence", "/memory"],
  "/word-speed": ["/typing", "/reading", "/verbal"],
  "/number-speed": ["/memory", "/reverse-memory", "/digit-span"],
  "/face-memory": ["/emotion", "/memory", "/chimp"],
  "/color-match": ["/stroop", "/reaction", "/color-memory"],
  "/focus-timer": ["/reaction", "/rhythm", "/memory"],
  "/digit-span": ["/memory", "/reverse-memory", "/number-speed"],
  "/emotion": ["/face-memory", "/reaction", "/stroop"],
  "/trail-making": ["/visual-memory", "/rotation", "/chimp"],
  "/go-no-go": ["/reaction", "/stroop", "/focus-timer"],
  "/n-back": ["/memory", "/reverse-memory", "/sequence"],
  "/hand-eye": ["/aim", "/anticipation", "/peripheral"],
  ...
  "/visual-search": ["/visual-memory", "/change-detection", "/peripheral"],
  "/peripheral-test": ["/peripheral", "/aim", "/visual-memory"],
  "/brain-score": ["/brain-age", "/reaction", "/n-back"],
  "/change-detection": ["/visual-search", "/visual-memory", "/dual-task"],
  "/dual-task": ["/peripheral-test", "/go-no-go", "/trail-making"],
  ...
  "/brain-age": ["/brain-score", "/reaction", "/chimp"],
};
