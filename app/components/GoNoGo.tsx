    ...
    return (
      <div className="text-center space-y-6">
        <div className="bg-paper-2 rounded-2xl p-8 border border-line">
          <p className="text-ink-2 text-sm mb-2">Average Reaction Time</p>
          <p className="text-6xl font-black text-green-400">{averageRT}ms</p>
          <p className="text-ink-2 text-sm mt-2">Accuracy: {accuracy}%</p>
        ...
        <div className="grid grid-cols-3 gap-3">
          <div className="bg-paper-2 rounded-xl p-4 border border-line">
            <p className="text-xs text-ink-3">Hits</p>
            <p className="text-xl font-bold text-green-400">{hits}/{goCount}</p>
          </div>
          <div className="bg-paper-2 rounded-xl p-4 border border-line">
            <p className="text-xs text-ink-3">Misses</p>
            <p className="text-xl font-bold text-orange-400">{misses}</p>
          </div>
          <div className="bg-paper-2 rounded-xl p-4 border border-line">
            <p className="text-xs text-ink-3">False Alarms</p>
        ...
        <div className="flex gap-3 justify-center">
          ...
          <button
            ...
            className="px-6 py-3 bg-green-600 text-ink font-bold rounded-xl hover:bg-green-700 transition-colors"
          >
            Share Score
          </button>
        </div>
  ...
  if (phase === "ready") {
    return (
      <div className="text-center">
        <button
          onClick={startGame}
          className="px-8 py-4 bg-green-600 text-ink font-bold text-xl rounded-2xl hover:bg-green-700 transition-colors"
        >
          Start Go/No-Go
        </button>
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative w-full h-80 md:h-96 bg-paper-2 rounded-2xl border border-line flex items-center justify-center">
        ...
        {!currentTrial && <p className="text-ink-3 text-lg">Ready...</p>}
      </div>
