...
export default function ChimpPage() {
  return (
    <main className="max-w-2xl mx-auto px-4 pt-12 pb-12">
      ...
      <section className="mt-12 space-y-6">
        <h2 className="text-2xl font-bold text-white">The Science Behind the Chimp Memory Test</h2>
        <p className="text-gray-300 leading-relaxed">
        ...
        <h3 className="text-xl font-bold text-white">Working Memory vs Short-Term Memory</h3>
        <p className="text-gray-300 leading-relaxed">
        ...
        <h3 className="text-xl font-bold text-white">Matsuzawa&apos;s Research at Kyoto University PRI</h3>
        <p className="text-gray-300 leading-relaxed">
        ...
        <h3 className="text-xl font-bold text-white">The Cognitive Trade-Off Hypothesis</h3>
        <p className="text-gray-300 leading-relaxed">
      ...
      <section className="mt-12">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
            <h3 className="font-bold text-white mb-2">Can I play the chimp memory test online for free?</h3>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
            <h3 className="font-bold text-white mb-2">What was Ayumu the chimpanzee&apos;s test score?</h3>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
            <h3 className="font-bold text-white mb-2">What is the Primate Research Institute Kyoto memory test?</h3>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
            <h3 className="font-bold text-white mb-2">How is this different from Human Benchmark&apos;s chimp test?</h3>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
            <h3 className="font-bold text-white mb-2">Does the chimp memory test measure IQ?</h3>
            <p className="text-gray-300">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
            <h3 className="font-bold text-white mb-2">Can children beat the chimp test more easily than adults?</h3>
            <p className="text-gray-300">
